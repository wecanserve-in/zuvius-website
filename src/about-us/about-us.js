...
const leaders = [
  {
    ...
    linkedin:
      "https://www.linkedin.com/in/nimishh-thakkar-90a78a14/",
    desc:
      "An audacious visionary with excellent entrepreneurial wisdom helps in achieving international standards with cost-effective methods.",
  },
  {
    name: "Dr. Ulhas Ganu",
    ...
    linkedin:
      "https://www.linkedin.com/in/dr-ulhas-ganu-81a885a/",
    desc:
      "Oncology research scientist with 27 years of experience, driving innovation and quality excellence at Zuvius.",
  },
  {
    ...
    linkedin:
      "https://www.linkedin.com/in/shailesh-shetty-6788006a/",
    desc:
      "Finance, Administration and HR leader with 18+ years of experience in building efficient and scalable operations.",
  },
  {
    ...
    linkedin:
      "https://www.linkedin.com/in/alka-chavan-ab881914/",
    desc:
      "Pharmaceutical marketing professional with 26 years of expertise across management, P&L, sales and marketing.",
  },
  {
    ...
    linkedin:
      "https://www.linkedin.com/in/swapnil-kamble-173334b9/",
    desc:
      "Marketing leader with 20 years of experience, known for driving growth and fostering a culture of innovation.",
  },
];
        ...
        <div className="about-container video-grid">
          ...
          <div className="small-line" />
            ...
            <p>
              ...
              range of anticancer drugs in the world. The company is
              headquartered in Mumbai, India, and is a global
              healthcare company specializing in chemotherapeutic
              formulations.
            </p>
      ...
      <section className="mission-section">
        <div className="about-container mission-grid">
          <div className="mission-card">
            <div className="mission-icon mission-target-icon">
              <img
                src="/aboutus/mission-target.png"
                alt="Archery target representing our mission"
              />
            </div>
            ...
            <div>
              ...
              <p>
                Steering towards a world where cancer is just another
                disease, treatable and curable! Redefining Health,
                Rediscovering Life.
              </p>
            </div>
          </div>
          ...
          <div className="mission-card vision-card">
            <div className="mission-icon vision-eye-icon">
              <FaEye />
            </div>
            ...
            <div>
              ...
              <p>
                To become a global leader in creating a holistic
                portfolio of quality cancer care that encompasses
                every aspect from early diagnosis to treatment to
                palliative care!
              </p>
            </div>
          </div>
            ...
            {timelineItems.map((item, timelineIndex) => (
              ...
              >
                ...
                <div className="timeline-card">
                  ...
                  <p className="timeline-short-text">
                    {item.short}
                  </p>

                  <div
                    className={`timeline-full-text ${
                      openTimeline === timelineIndex
                        ? "show"
                        : ""
                    }`}
                  >
